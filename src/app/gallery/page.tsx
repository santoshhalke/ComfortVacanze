...
//     // { id:16 , src: '/images/gallery/travel_16.jpg', alt: 'Creative artwork', orientation: 'landscape'},
//     // { id:17 , src: '/images/gallery/travel_17.jpg', alt: 'Creative artwork', orientation: 'landscape'},
//     // { id:18 , src: '/images/gallery/travel_18.jpg', alt: 'Creative artwork', orientation: 'landscape'},
...
const GalleryPage = () => {
  const images = [
    ...
    { id: 16, src: '/images/gallery/travel_16.jpg', alt: 'Creative addition', orientation: 'landscape' },
    { id: 17, src: '/images/gallery/travel_17.jpg', alt: 'Another artwork', orientation: 'landscape' },
    { id: 18, src: '/images/gallery/travel_18.jpg', alt: 'Final image', orientation: 'portrait' },
    { id: 19, src: '/images/gallery/travel_19.jpg', alt: 'Final image', orientation: 'landscape' },
    { id: 20, src: '/images/gallery/travel_20.jpg', alt: 'Final image', orientation: 'landscape' },
    { id: 21, src: '/images/gallery/travel_21.jpg', alt: 'Final image', orientation: 'portrait' },
    { id: 22, src: '/images/gallery/travel_22.jpg', alt: 'Final image', orientation: 'landscape' },
    { id: 23, src: '/images/gallery/travel_23.jpg', alt: 'Final image', orientation: 'landscape' }
  ];
