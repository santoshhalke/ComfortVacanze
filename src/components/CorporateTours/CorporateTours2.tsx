    ...
    <section className="py-16 bg-white">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           >
             ...
             <motion.p 
               variants={fadeIn}
               className="text-lg text-center mb-12 max-w-4xl mx-auto text-gray-600"
             >
               The collaboration between Comfort Vacanze and SS World Holidays combines decades of experience in corporate travel management, offering unparalleled expertise in designing and executing global corporate events. Our joint venture delivers innovative solutions tailored to meet the unique needs of international businesses.
             </motion.p>
